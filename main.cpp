...
//
    ...
    //           );        
//
    //world.createAndAddSphere(vec3(-0.3, 0.19, 1), 0.2);
    //world.createAndAddCylinder(vec3(-0.3, -0.2, 1),
    //                           0.15,
    //                           0.2,
    //                           vec3(1,0,0).return_unit());
    //world.createAndAddTriangle(vec3(0, 0, 1),
    //                           vec3(0.5, 0, 1),
    //                           vec3(0.25,  0.25, 1));
//
